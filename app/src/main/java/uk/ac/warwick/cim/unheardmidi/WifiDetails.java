...
public class WifiDetails {
    ...
    public WifiDetails(File fName, MidiManager manager, Context ctx) {
        mContext = ctx;
        fileName = fName;
        midiConnection = new MidiConnection(mContext);
        midiManager = manager;
    ...
    private void scanSuccess() {
        ...
        try {
            ...
            for (ScanResult scan : results) {
                ...
                midiConnection.sendNoteToDevice(midiManager, "wifi");
            }
        } catch (Exception e) {
            System.out.print(e);
        }
